    ...
    return (
      ...
      <Banner />
        ...
        <List.Item>
          ...
          <List.Content>Sally's Bakery</List.Content>
        </List.Item>
        <List.Item>
          <List.Icon name='marker' />
          <List.Content>Mount Druitt, Sydney</List.Content>
        </List.Item>
        <List.Item>
          <List.Icon name='mail' />
          <List.Content>
            <a href='mailto:samstore@fakeeeee81!.com'>sally@gmail.com</a>
          </List.Content>
        </List.Item>
        <List.Item>
          <List.Icon name='linkify' />
          <List.Content>
            <a href='https://samsstorenotreal.com'>sallybake.com</a>
          </List.Content>
        </List.Item>
        </List>
        <div>
